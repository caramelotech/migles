...
export function PublicPreview() {
  ...
  if (!event)
    return (
      <div style={{ padding: 32, color: T.text2, textAlign: 'center' }}>Evento não encontrado.</div>
    )
    ...
    <div style={{ minHeight: '100vh', background: T.bg, display: 'flex', flexDirection: 'column' }}>
      ...
      >
        ...
        <div style={{ display: 'flex', gap: 8 }}>
          <Button variant="ghost" sz="sm" onClick={() => navigate('/')}>
            Entrar
          </Button>
          <Button sz="sm" onClick={() => navigate('/')}>
            Criar conta
          </Button>
        </div>
      </div>
      ...
      <div style={{ flex: 1, display: 'flex', justifyContent: 'center' }}>
        <div style={{ width: '100%', maxWidth: 720, padding: '40px 24px' }}>
          {/* Community badge */}
          ...
          <div
            style={{
              background: `linear-gradient(135deg, ${cc}18 0%, ${T.accentDim} 100%)`,
          ...
          >
            ...
            {!rsvpClicked ? (
              <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
                <Button sz="lg" onClick={() => setRsvpClicked(true)}>
                  Confirmar presença
                </Button>
                <Button variant="ghost" sz="lg" onClick={() => navigate('/')}>
                  Já tenho conta
                </Button>
              </div>
            ) : (
              <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
                <Button sz="lg" onClick={() => navigate('/')}>
                  Criar conta grátis
                </Button>
                <Button variant="ghost" sz="lg" onClick={() => navigate('/')}>
                  Fazer login
          ...
          >
            <Logo size={40} />
            <div style={{ flex: 1 }}>
              <div style={{ fontWeight: 600, marginBottom: 3, fontSize: 15, color: T.text }}>
                Baixe o Migles
              </div>
              <div style={{ fontSize: 13, color: T.text2 }}>
                Organize seus encontros. Disponível para iOS e Android.
              </div>
            </div>
